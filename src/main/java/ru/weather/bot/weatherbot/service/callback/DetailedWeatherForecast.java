...
@Component
public class DetailedWeatherForecast implements CallBackHandler
{
    private final Deque<BotApiMethod<?>> stackMessages;
    private final WeatherMapper weatherMapper;

    @Autowired
    public DetailedWeatherForecast(Deque<BotApiMethod<?>> stackMessages, WeatherMapper weatherMapper)
    {
    ...
    public BotApiMethod<?> processCallBack(Update update)
    {
        ...
        return EditMessageText.builder()
                ...
                .text(weatherMapper.detailedWeatherForecast(cityName, weatherMapper.getReceiveData().getWeatherConfig().getCurrentDay()))
